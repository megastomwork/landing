...
>(({ className, variant = 'outline', size = 'icon', ...props }, ref) => {
  ...
  return (
    <div
      ...
      onClick={!canScrollPrev ? undefined : scrollPrev}
    >
      <Button
        ref={ref}
        variant={variant}
        size={size}
        className={cn(
          'h-10 w-10 rounded-full border-black transition hover:scale-90 hover:bg-transparent',
          className,
        )}
...
>(({ className, variant = 'outline', size = 'icon', ...props }, ref) => {
  ...
  return (
    <div
      className="flex h-full cursor-pointer items-center justify-center"
      onClick={!canScrollNext ? undefined : scrollNext}
    >
      <Button
        ref={ref}
        variant={variant}
...
const CarouselProgress = ({
  ...
  return (
    <div
      className={cn(
        'relative ml-auto mr-4 h-[3px] w-full max-w-[400px] overflow-hidden bg-gray-200',
        className,
      )}
      {...props}
    >
...
CarouselPointCounters.displayName = 'CarouselPointCounters';
