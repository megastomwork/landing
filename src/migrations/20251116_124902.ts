...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "pages_blocks_doctors" DROP COLUMN "title";
  ALTER TABLE "pages_blocks_doctors" DROP COLUMN "description";
  ALTER TABLE "_pages_v_blocks_doctors" DROP COLUMN "title";
  ALTER TABLE "_pages_v_blocks_doctors" DROP COLUMN "description";`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "pages_blocks_doctors" ADD COLUMN "title" varchar DEFAULT 'Наші лікарі';
  ALTER TABLE "pages_blocks_doctors" ADD COLUMN "description" varchar;
  ALTER TABLE "_pages_v_blocks_doctors" ADD COLUMN "title" varchar DEFAULT 'Наші лікарі';
  ALTER TABLE "_pages_v_blocks_doctors" ADD COLUMN "description" varchar;`)
}
